...
main = do
  let accepted =
        preGenesisToGenesis preGenesisState validObservation
      rejectedBelow =
        preGenesisToGenesis preGenesisState belowThresholdObservation
      rejectedSource =
        preGenesisToGenesis preGenesisState wrongSourceObservation
      rejectedReplay =
        preGenesisToGenesis genesisState validObservation
      malformed =
        PreRichRegimeState Active

  assert
    (accepted == Just genesisState)
