...
describe('PRE-RICH ticket-level Reveal refinement', () => {
  ...
  it('binds ticket payout to the sum of both row payouts, capped at 500x', () => {
    ...
    expect(() => validateRevealRefinementEvidence({ ...base, row1PayoutSubunits: 40_000n, row2PayoutSubunits: 20_000n, prizeAmountSubunits: 50_000n, pendingLiabilityAfter: 50_500n, totalLiquidityBefore: 70_000n })).not.toThrow()
